...
class GoogleMapScreenFour extends StatefulWidget {
  String ?busId;
  GoogleMapScreenFour({this.busId});

  @override
  _GoogleMapScreenFourState createState() => _GoogleMapScreenFourState();
}

class _GoogleMapScreenFourState extends State<GoogleMapScreenFour> {
