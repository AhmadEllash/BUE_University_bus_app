...
class GoogleMapScreenSeven extends StatefulWidget {
  String ?busId;
  GoogleMapScreenSeven ({this.busId});

  @override
  _GoogleMapScreenSevenState createState() => _GoogleMapScreenSevenState();
}

class _GoogleMapScreenSevenState extends State<GoogleMapScreenSeven> {
