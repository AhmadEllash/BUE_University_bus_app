...
class GoogleMapScreenNine extends StatefulWidget {
  String ?busId;
  GoogleMapScreenNine({this.busId});

  @override
  _GoogleMapScreenNineState createState() => _GoogleMapScreenNineState();
}

class _GoogleMapScreenNineState extends State<GoogleMapScreenNine> {
