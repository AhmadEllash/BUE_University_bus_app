...
class GoogleMapScreenSix extends StatefulWidget {
  String ?busId;
  GoogleMapScreenSix({this.busId});

  @override
  _GoogleMapScreenSixState createState() => _GoogleMapScreenSixState();
}

class _GoogleMapScreenSixState extends State<GoogleMapScreenSix> {
